...
const About = () => {
  return (
    <div name='about' className='p-2 sm:p-4 flex items-center justify-center bg-gradient-to-b from-slate-700 to-slate-900 text-white py-10 w-full h-full sm:min-h-screen'>
        ...
        <p className='mb-10 text-slate-300 md:text-2xl'>
        ...
        <p className='mb-2  sm:mb-10 text-slate-300 md:text-2xl '>
